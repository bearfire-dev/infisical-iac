...
# Exports the requested class plus the backup class (every apply snapshots first).
...
echo "exported ${prefix}_R2_* and TF_BACKUP_R2_* for class '$class' (project $slug/$env)" >&2
