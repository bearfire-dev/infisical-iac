...
2. Search for `@paperkeel/env`, `createBearfireEnv`, `createRequestEnv`, `process.env`, Worker bindings, and workflow secret references.
...
Grant the consumer repository read access to the `@paperkeel/env` package in GitHub
