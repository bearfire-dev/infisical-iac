...
- [ ] Dependent application PR(s) reference this PR as `Depends on bearfire-dev/infisical-iac#<n>` and wait for `pnpm secrets:check <slug>` to pass.

## Depends on / blocks

<!-- e.g. Blocks bearfire-dev/sigla-writer#123 -->
